      ...
      <div className="AuthContainer">
          <form className="AuthWrapper container-border-global">
              ...
              <div className="Auth__input-group">
                  ...
                  <div className="Auth__input-group__wrapper input-wrapper-global">
                    <i className="fa-solid fa-circle-user Auth__input-icon"></i>
                    <input type="text" placeholder="ex. My Cocks Lang" className="Auth__input-text input-text-global"></input>
                  </div>
              </div>
              <div className="Auth__input-group">
                  ...
                  <div className="Auth__input-group__wrapper input-wrapper-global">
                    ...
                    <input type="email" placeholder="ex. MikeOxlong69" className="Auth__input-text input-text-global"></input>
                  </div>
              </div>
              <div className="Auth__input-group">
